...
python train_habitat_curiosity.py --scene_path /home/kojogyaase/Projects/Research/recovery-from-failure/data/gibson/Cantwell.glb --scene_dataset_path "" --video_interval 10000 --video_length 200 --debug_render
