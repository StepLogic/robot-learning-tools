...
- Goal image support with MobileNetV3 features
- Full relabel all goals in replay buffer after episode
"""
import random
...
from wrappers import EnvCompatibility, Logger, MobileNetFeatureWrapper, MobileNetV3Encoder, RewardWrapper, save_checkpoint, StackingWrapper
...
flags.DEFINE_integer("start_training", int(3e3), "Number of training steps to start training.")
...
flags.DEFINE_boolean("use_goal_image", False, "Include goal image in observations.")
...
# ============================================================================
# GoalRelObservationWrapper with Goal Masking, Angle/Distance, and Image Support
# ============================================================================
